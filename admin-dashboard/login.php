...
<div style="border: 1px solid #000;  padding: 30px;  border-radius: 12px; max-width: 400px; box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.1);">
    <form method="POST">
        ...
        <div class="form-group">
            <input type="submit" class="btn" name="login_btn" id="login-btn" value="Login">
                ...
                <div class="form-group">
                <a id="forgot-password"  class="text-decoration-none text-center" style="padding: 10px;">
                    Forgot Password?
                </a>
            </div>  
